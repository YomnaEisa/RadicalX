...
if __name__ == "__main__":
    ...
    embed_config = {
        ...
        "project": "gemini-quizzify-425516",
    ...
    with screen.container():
        ...
        chroma_creator = ChromaCollectionCreator(processor, embedding_client) # Initialize from Task 5
        ...
        with st.form("Load Data to Chroma"):
            ...
            # 5) for the quiz topic and the desired number of questions
            ####### YOUR CODE HERE #######
            quiz_topic = st.text_input("Enter a Quiz Topic: ")
